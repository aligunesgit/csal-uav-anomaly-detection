...
Data acquisition was performed during the summer of 2018 in the Galicia region of Spain, utilizing a MicaSense RedEdge multispectral sensor integrated into a specialized Uncrewed Aerial Vehicle (UAV). To capture the fluvial ecosystems, aerial imagery was collected at a flight altitude of 120 m, yielding a high spatial resolution of 8.2 cm/pixel. The sensor recorded spectral reflectance across five distinct bands: blue (475 nm), green (560 nm), red (668 nm), red edge (717 nm), and near-infrared (NIR) (840 nm) \cite{arguello2021watershed}.

The resulting dataset, publicly available in \cite{galicianriversaddataset}, comprises four distinct scenes depicting semi-natural ecosystems with dense vegetation. Within this framework, anthropogenic features, such as buildings and roads, are defined as anomalies to be flagged for ecosystem management monitoring. Reflecting realistic environmental conditions, these anomalous pixels constitute only a small fraction of the total dataset. However, because undetected human interventions can precipitate severe ecological degradation, achieving a high detection rate (i.e., minimizing false negatives) is paramount for this application.


The primary characteristics of the four selected images are summarized in Table \ref{tab:data-description}. Across the dataset, anomalous pixels exhibit a low prevalence, ranging from $3\%$ to $12\%$ of the total pixel count per image. The storage footprint of each image is determined by its spatial dimensions, with individual pixel values stored in a 4-byte precision format.
...
\footnotesize
    ...
    \begin{tabular}{l r r r r }
        \toprule
        \textbf{Name}	&	 {\textbf{z1}}	&	 {\textbf{z2}}	&	 {\textbf{e1}}	&	 {\textbf{e2}}  \\
        \midrule
...
The remote sensing images and associated reference maps of anomalies used in this work are displayed in Figure \ref{fig:dataset}. 

% Trasposed alternative
% \begin{figure*}[t]
% \captionsetup[subfloat]{farskip=2pt,captionskip=1pt}

%   \centering
% \subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/z1/z1_color.png}\label{fig:z1rgb}}%
% ~\subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/z2/z2ADcut_color.png}\label{fig:z2rgb}}%
% ~\subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/e1/ermidasAD1.png}\label{fig:e1rgb}}%
% ~\subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/e2/ermidasAD2.png}\label{fig:e2rgb}}%

% \subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/z1/z1_gt.png}\label{fig:z1gt}}%
% ~\subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/z2/z2v2_gt.png}\label{fig:z2gt}}%
% ~\subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/e1/ermidasAD1_gt.png}\label{fig:e1gt}}%
% ~\subfloat[][]{\includegraphics[width=0.24\linewidth]{figs/e2/ermidasAD2_gt.png}\label{fig:e2gt}}%


% \caption{RGB composition [a-- d] and reference data of anomalies (anomalies in white) [e-- h] for z1, z2, e1, and e2 images, respectively. }
%   \label{fig:dataset}
% \end{figure*}
...
~\subfloat[][]{\includegraphics[width=0.48\linewidth]{figs/z1/z1_gt.png}\label{fig:z1gt}}%

\subfloat[][]{\includegraphics[width=0.48\linewidth]{figs/z2/z2ADcut_color.png}\label{fig:z2rgb}}%
~\subfloat[][]{\includegraphics[width=0.48\linewidth]{figs/z2/z2v2_gt.png}\label{fig:z2gt}}%

\subfloat[][]{\includegraphics[width=0.48\linewidth]{figs/e1/ermidasAD1.png}\label{fig:e1rgb}}%
~\subfloat[][]{\includegraphics[width=0.48\linewidth]{figs/e1/ermidasAD1_gt.png}\label{fig:e1gt}}%

\subfloat[][]{\includegraphics[width=0.48\linewidth]{figs/e2/ermidasAD2.png}\label{fig:e2rgb}}%
~\subfloat[][]{\includegraphics[width=0.48\linewidth]{figs/e2/ermidasAD2_gt.png}\label{fig:e2gt}}%


\caption{RGB composition [a,c,e,g] and reference data of anomalies (anomalies in white) [b,d,f,h] for z1, z2, e1, and e2 images, respectively. }
  \label{fig:dataset}
\end{figure}
